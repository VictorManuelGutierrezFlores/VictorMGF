...
@app.get("/listapasajeros/", status_code = 200)
async def listapasajeros():
    return  (passengers_list)

#CREACION DE POST METHOD
@app.post("/listapasajeros/", status_code = 201)
...
@app.put("/listaspasajeros/", status_code = 200)
async def listapasajeros(person:Passenger):
...
#DELETE METHOD
@app.delete("/listapasajeros/{id}", status_code = 200)
async def listapasajeros(id:int):
    ...
    if not found:
        raise HTTPException(status_code = 401, detail="USUARIO BORRADO")